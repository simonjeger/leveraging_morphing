...
class VecEnvBase {
   public:
	...
	virtual bool step(Ref<MatrixRowMajor<>> act, Ref<Vector<>> dt, Ref<MatrixRowMajor<>> obs, Ref<MatrixRowMajor<>> reward,
   ...
   protected:
	...
	virtual void perAgentStep(int agent_id, Ref<MatrixRowMajor<>> act, Ref<Vector<>> dt, Ref<MatrixRowMajor<>> obs,
